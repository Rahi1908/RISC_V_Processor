...
output reg signed [31:0] offset
    ...
    assign ins_i = ins[31:20]; //I-Type
    assign ins_s = {ins[31:25],ins[11:7]}; //S-Type
    assign ins_b = {ins[31],ins[7],ins[30:25],ins[11:8],1'b0}; //B-Type
    assign ins_j = {ins[31],ins[19:12],ins[20],ins[30:21],1'b0}; //J-Type
